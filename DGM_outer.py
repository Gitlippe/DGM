...
def main():
    ...
    # Priority: env var (RANDOM_SEED) > --random_seed > --seed
    seed = RANDOM_SEED if RANDOM_SEED is not None else (args.random_seed if args.random_seed is not None else args.seed)
    if seed is not None:
        random.seed(seed)
